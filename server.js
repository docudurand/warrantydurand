...
app.get("/admin", checkAdmin, (req, res) => {
  ...
  <img class="banniere-admin" src="https://raw.githubusercontent.com/docudurand/warrantydurand/main/assets/banniere.png" alt="Bannière">
  <div class="admin-content">
    ...
    <script>
      // Le script JS ici (identique à ta version précédente, non modifié pour la démo)
    </script>
  </div>
  `;
  res.send(html);
